...
const fetchProjectDetails = async(project_id: number) => {
  try {
    const response = await fetch(`https://collab-eijr.onrender.com/project/view_details?project_id=${project_id}`, {
      method: "GET",
      credentials: "include",
      headers: {
...
const updateProjectStatus = async (project_id: number, newStatus: string, userId: string) => {
  try {
    const response = await fetch(`https://collab-eijr.onrender.com/project/update_status`, {
      method: "POST",
      credentials: "include",
      headers: {
        "Content-Type": "application/json",
...
const submitProjectRating = async (project_id: number, userId: string, rating: number) => {
  try {
    const response = await fetch(`https://collab-eijr.onrender.com/project/give_rating`, {
      method: "POST",
      credentials: "include",
      headers: {
        "Content-Type": "application/json",
