...
export default function NotificationBell() {
  ...
  const fetchNotifications = async () => {
    try {
      ...
      const testResponse = await fetch("https://collab-eijr.onrender.com/ping", {
        method: "GET",
        credentials: "include",
        headers: {
      ...
      const response = await fetch("https://collab-eijr.onrender.com/notification", {
        method: "POST",
        credentials: "include",
        headers: {
          "Content-Type": "application/json",
  ...
  const handleAcceptRequest = async (applicationId: number,project_id:number,applicant_id:string, accept: boolean) => {
    try {
      setLoading(true)
      const response = await fetch("https://collab-eijr.onrender.com/update/project/app/status", {
        method: "POST",
        credentials: "include",
        headers: {
          "Content-Type": "application/json",
